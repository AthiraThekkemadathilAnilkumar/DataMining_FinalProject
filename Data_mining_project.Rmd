...
# Create subplots for each type using ggplot2
 ...
 plot1 <- ggplot(pokemon, aes(x = IsLegendary, y = attack, fill = "pink")) +
  geom_boxplot() +
 ...
 plot1
  ...
  plot2 <- ggplot(pokemon, aes(x = IsLegendary, y = defense, fill = "lightyellow")) +
  geom_boxplot() +
 ...
 plot3 <- ggplot(pokemon, aes(x = IsLegendary, y = sp_attack , fill = "lightblue")) +
  geom_boxplot() +
 ...
 plot4 <- ggplot(pokemon, aes(x = IsLegendary, y = sp_defense, fill = "lightgreen")) +
  geom_boxplot() +
 ...
 plot5 <- ggplot(pokemon, aes(x = IsLegendary, y = speed, fill = "violet")) +
  geom_boxplot() +
 ...
 plot6 <- ggplot(pokemon, aes(x = IsLegendary, y = hp, fill = "red")) +
  geom_boxplot() +
...
clust_poke$Tier <- as.numeric(as.character(clust_poke$Tier))
